...
class Standing(db.Model):
    ...
    average_goalsFor = db.Column(db.Float, nullable=False)
    average_home_goalsFor = db.Column(db.Float, nullable=False)
    average_away_goalsFor = db.Column(db.Float, nullable=False)

    average_goalsAgainst = db.Column(db.Float, nullable=False)
    average_home_goalsAgainst= db.Column(db.Float, nullable=False)
    average_away_goalsAgainst = db.Column(db.Float, nullable=False)

    failed_to_score = db.Column(db.Integer, nullable=False) #nie strzelnie gola
    home_failed_to_score = db.Column(db.Integer, nullable=False)
    away_failed_to_score = db.Column(db.Integer, nullable=False)

    clean_sheet = db.Column(db.Integer, nullable=False) #nie stracił gola
    home_clean_sheet = db.Column(db.Integer, nullable=False)
    away_clean_sheet = db.Column(db.Integer, nullable=False)
    
    yellow_cards_total = db.Column(db.Integer, nullable=False)
    red_cards_total = db.Column(db.Integer, nullable=False)

    penalty = db.Column(db.Integer, nullable=False)
    penalty_scored = db.Column(db.Integer, nullable=False)
    penalty_missed = db.Column(db.Integer, nullable=False)
